  ...
  mounted() {
    this.$api
      ...
      .then(res => {
        ...
        this.$store.commit("setFloor2",res.data.floor2)
        this.$store.commit("setFloor3",res.data.floor3)
        this.$store.commit("setFloorName",res.data.floorName.floor1)
        this.$store.commit("setFloorName",res.data.floorName.floor2)
        this.$store.commit("setFloorName",res.data.floorName.floor3)
